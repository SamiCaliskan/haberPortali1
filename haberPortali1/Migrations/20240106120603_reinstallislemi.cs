...
namespace haberPortali1.Migrations
{
    /// <inheritdoc />
    public partial class reinstallislemi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HaberTurleri", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HaberTuruId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Haberler_HaberTurleri_HaberTuruId",
                        column: x => x.HaberTuruId,
                        principalTable: "HaberTurleri",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
